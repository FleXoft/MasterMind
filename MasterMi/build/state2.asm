...
; * July 2002
; *
; * WristApp: MasterMind v: 1.0 (final)
; *
; ********************************************************************
...
$LIST OFF
    ...
    INCLUDE 'C:\M851\App\MasterMi\build\COMMINC.H'
    ...
    INCLUDE 'C:\M851\App\MasterMi\h\mmvars.h'
    INCLUDE 'C:\M851\App\MasterMi\h\mm.h'
...
CODESTATEADDRESS     equ     CommonCodeEnd
    ...
    INCLUDE 'C:\M851\App\MasterMi\src\mmsetbn.asm'
