...
REM * July 2002
REM *
REM * WristApp: MasterMind v: 1.0 (final)
REM *
REM ********************************************************************
...
rem Build state3 Handler
c:\c88\bin\as88.exe state3.asm -fascmd.cmd
c:\c88\bin\lk88.exe state3.obj -o state3.out -flkcmd.cmd
c:\c88\bin\lc88.exe state3.out -o state3.sre -flccmd.cmd


rem Build state4 Handler
c:\c88\bin\as88.exe state4.asm -fascmd.cmd
c:\c88\bin\lk88.exe state4.obj -o state4.out -flkcmd.cmd
c:\c88\bin\lc88.exe state4.out -o state4.sre -flccmd.cmd
